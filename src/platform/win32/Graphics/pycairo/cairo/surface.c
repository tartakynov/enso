...
PyTypeObject PycairoSVGSurface_Type = {
  PyObject_HEAD_INIT(NULL)
  0,                                  /* ob_size */
  "enso.platform.win32.cairo.SVGSurface",                 /* tp_name */
...
PyTypeObject PycairoWin32PrintingSurface_Type = {
  PyObject_HEAD_INIT(NULL)
  0,                                  /* ob_size */
  "enso.platform.win32.cairo.Win32PrintingSurface",       /* tp_name */
...
PyTypeObject PycairoXCBSurface_Type = {
  PyObject_HEAD_INIT(NULL)
  0,                                  /* ob_size */
  "enso.platform.win32.cairo.XCBSurface",                 /* tp_name */
...
PyTypeObject PycairoXlibSurface_Type = {
  PyObject_HEAD_INIT(NULL)
  0,                                  /* ob_size */
  "enso.platform.win32.cairo.XlibSurface",                /* tp_name */
